      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-white rounded-2xl p-8 md:p-12 border border-gray-100 shadow-sm">
          ...
          <p className="text-gray-700 leading-relaxed mt-4">
            Наша місія — зробити процес купівлі авто прозорим, чесним та безпечним. Кожна перевірка проводиться за понад 100 параметрами, а наш детальний звіт допоможе вам прийняти правильне рішення.
          </p>
        </div>
      </div>
    </section>
